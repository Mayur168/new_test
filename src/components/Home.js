...
// //               Remove
// //             </button> 
// //             <button className="home-edit-button-submit" onClick={handleSaveEdit}>
// //                     Sumit
// //                   </button>
// //                 </div>
...
//             setIsApiLoading(false); // Reset the loading state if error
//         }
...
//                 "https://django-imageprocessing-api.vercel.app/api/imageprocess/updatedata/",
//                 data
//             );
//              return response
//         } catch (error) {
