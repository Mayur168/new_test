...
//                          className="home-form-input"
//                         style={{ zIndex: 10000 }}
//                         value={editFormData?.["B/P"] || ""}
//                          onChange={(e) => handleInputChange(e, "B/P")}
//                         />
//                   </div>
//                  <div className="home-form-group">
//                      <label className="home-form-label">
...
//                        className="home-form-input"
//                        style={{ zIndex: 10000 }}
//                        value={editFormData?.["Follow up date"] || ""}
//                        onChange={(e) => handleInputChange(e, "Follow up date")}
//                      />
//                   </div>
//                   <div className="home-form-group">
//                        <label className="home-form-label">
...
//                 </p>
//                   <p className="prescription">
//                   <strong>Blood Pressure:</strong> {selectedData["B/P"] || 'N/A'}
//                 </p>
//                    <p className="prescription">
//                      <strong>Complaint Section:</strong> {selectedData.complaints || 'N/A'}
//                  </p>
//                   <p className="prescription">
//                   <strong>Follow Up Date:</strong> {selectedData["Follow up date"] || 'N/A'}
//                 </p>
//                  <p className="prescription">
